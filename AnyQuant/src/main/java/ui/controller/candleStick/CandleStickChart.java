 ...
 *       price movements of a security, derivative, or currency over time. The
 *       Data Y value is used for the opening price and then the close, high and
...
class CandleStickChart extends XYChart<String, Number> {
	...
	// ------------------------------------------------------------------------------------------
	/**
	 * Called to update and layout the content for the plot 更新布局
	 */
	@Override
