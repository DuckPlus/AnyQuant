...
public class BenchMarkDAOImplTest {
    ...
    public void getMaxDate() throws Exception {
        ...
        System.out.print("benchdata maxDate :"+myDate.DateToString());
    }

    @Test
    public void getAllBenchMarkCodes() throws Exception {
        List<String> codes = dao.getAllBenchMarkCodes();
        if(codes==null){
            fail("getAllBenchMarkCodes() ---null");
        }else{
